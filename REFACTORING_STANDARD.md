...
**Порядок.**
1. R1.1a → R1.1b → R2.1a → R2.1b → R1.2 → R2.2a → R2.2b → R2.3.
...
**Итог:** 43 задачи. Боевых прогонов на этапе R не нужно. Исключение — контрольный прогон режима А после R5.1c: он показывает, что пакет и консоль не изменились.
...
- Этап разрезан на 43 задачи объёмом не больше M.
