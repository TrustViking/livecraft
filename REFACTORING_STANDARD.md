...
- Запись личного файла (`VaultStore.save_local`) старый файл не читает — повреждённый файл можно просто заменить. Исправление — в R1.1: настройщик читает поставочный слой строго, а повреждённый личный — как пустой с пометкой; окно открывается, первое сохранение заменяет файл.
...
|---|---|---|---|---|
| R1.1 | Дефекты D1–D7 и D9; промт перевыдан Коворком 25-09-2026 (первый Codex не выполнял) | 3, D9 | — | M |
